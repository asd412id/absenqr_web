<div class="card">
  ...
  <div class="card-body">
    <div class="form-group">
      ...
      <input type="text" name="asal_sekolah" class="form-control" id="asal_sekolah" value="{{ old('asal_sekolah') }}" placeholder="Asal Sekolah">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" name="kelas" class="form-control" id="kelas" value="{{ old('kelas') }}" placeholder="Kelas">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" name="nomor_ijazah" class="form-control" id="nomor_ijazah" value="{{ old('nomor_ijazah') }}" placeholder="Nomor Ijazah">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" name="pendidikan_lanjut" class="form-control" id="pendidikan_lanjut" value="{{ old('asal_sekolah') }}" placeholder="Melanjutkan Pendidikan di">
    </div>
  </div>
</div>
