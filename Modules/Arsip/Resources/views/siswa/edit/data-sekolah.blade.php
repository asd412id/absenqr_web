<div class="card">
  ...
  <div class="card-body">
    ...
    <div class="form-group">
      ...
      <input type="text" name="tanggal_diterima" class="form-control datepicker" id="tanggal_diterima" value="{{ $data->tanggal_diterima }}" placeholder="Tanggal Diterima">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" name="tanggal_tamat" class="form-control datepicker" id="tanggal_tamat" value="{{ $data->tanggal_tamat }}" placeholder="Tanggal Tamat">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" name="tanggal_ijazah" class="form-control datepicker" id="tanggal_ijazah" value="{{ $data->tanggal_ijazah }}" placeholder="Tanggal Ijazah">
    </div>
    <div class="form-group">
