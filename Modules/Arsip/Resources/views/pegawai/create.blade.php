...
@section('head_desc','Tambah Data Pegawai Baru')
@section('breadcrumb')
...
<form action="{{ route('pegawai.store') }}" enctype="multipart/form-data" method="post">
  ...
  <div class="row">
    <div class="col-sm-6">
      @include('arsip::pegawai.create.data-pribadi')
    </div>
    <div class="col-sm-6">
      @include('arsip::pegawai.create.data-login')
      @include('arsip::pegawai.create.data-kesehatan')
      @include('arsip::pegawai.create.data-pendidikan')
    </div>
