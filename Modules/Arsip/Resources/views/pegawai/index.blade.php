      ...
      <div class="card">
        <div class="card-header clearfix cd-title">
          @if (\Auth::user()->role == 'admin')
            <a href="{{ route('pegawai.create') }}" class="btn btn-sm mr-1 btn-primary"><i class="ik ik-user-plus"></i>
              Tambah Data</a>
          ...
          @endif
          <a href="javascript:void(0)" class="btn btn-sm btn-danger btn-print" target="_blank"><i
              class="fas fa-file-pdf"></i> Expor PDF</a>
        </div>
        <div class="card-body">
    ...
    <div class="modal fade" id="importModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form id="form-import" action="{{ route('pegawai.import.excel') }}" method="post"
            ...
            <div class="modal-body">
              ...
              <div class="mt-2">
                <label for="update">
                  ...
                  Update Data <em>(Memperbaharui data lama)</em>
                </label>
                <label for="new">
              ...
              <div class="mt-1 text-center">
                <div class="alert alert-success">
                  <em>Format file Excel harus sesuai dengan template! Silahkan <a
                      href="{{ route('pegawai.download.template.excel') }}" class="text-danger font-weight-bold">download
