<div class="card">
  ...
  <div class="card-body">
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <div class="form-radio">
            ...
            <div class="radio radio-default radio-inline">
              <label>
                <input type="radio" name="status_kepegawaian" value="ptt" {{ old('status_kepegawaian')=='ptt'?'checked':'' }}>
    ...
    <div class="form-group">
      ...
      <input type="text" name="mulai_masuk" class="form-control datepicker" id="mulai_masuk" value="{{ old('mulai_masuk') }}" placeholder="Mulai Masuk">
    </div>
    <div class="form-group">
