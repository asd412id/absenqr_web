...
Route::prefix('arsip')->middleware('web', 'auth', 'roles:admin,pegawai')->group(function () {
    ...
    Route::prefix('pegawai')->group(function () {
        ...
        Route::middleware('roles:admin')->group(function () {
            ...
            Route::post('/impor', 'PegawaiController@importExcel')->name('pegawai.import.excel');
            Route::get('/download-template-excel', 'PegawaiController@downloadTemplateExcel')->name('pegawai.download.template.excel');
