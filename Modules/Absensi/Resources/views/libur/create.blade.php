...
@section('content')
<form action="{{ route('absensi.libur.store') }}" enctype="multipart/form-data" method="post">
  @csrf
  <div class="row">
    <div class="col-sm-6">
      <div class="card">
        <div class="card-header">
          <h3>Hari Libur Baru</h3>
        </div>
        <div class="card-body">
          ...
          <div class="form-group">
            <div class="row">
              <div class="col-sm-6">
                ...
                <input type="text" name="start" class="form-control" id="start" value="{{ old('start')??date('Y/m/d') }}" required placeholder="Tanggal Mulai">
              </div>
              <div class="col-sm-6">
                <label for="end">Tanggal Selesai</label>
                <input type="text" name="end" class="form-control" id="end" value="{{ old('end')??date('Y/m/d') }}" required placeholder="Tanggal Selesai">
              </div>
            </div>
          </div>
          <div class="form-group">
